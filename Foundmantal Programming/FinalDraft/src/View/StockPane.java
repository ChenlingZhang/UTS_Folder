    ...
    private void initComponents() {
        ...
        //======== dialogPane ========
        {
            ...
            //======== scrollPane1 ========
            {
                ...
                productTable.setBackground(new Color(204, 204, 204));
                            ...
                            .addGroup(dialogPaneLayout.createSequentialGroup()
                                ...
                                .addGroup(dialogPaneLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                    .addGroup(dialogPaneLayout.createSequentialGroup()
                                        ...
                                        .addGroup(dialogPaneLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                            .addComponent(ID, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                            .addComponent(Name, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                            .addComponent(Type, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                            .addComponent(Max, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                            .addComponent(Current, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                            .addComponent(Stage, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                            .addComponent(Min, GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)))
                                    .addGroup(dialogPaneLayout.createSequentialGroup()
                                        .addGap(28, 28, 28)
                                        .addGroup(dialogPaneLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                            .addComponent(Delete, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                            .addComponent(Update, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                            .addComponent(Add_Stock, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                            .addComponent(View_Penishable, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                            .addComponent(View_unpenishable, GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                            .addComponent(View_All, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE)
                                            .addComponent(GoBack, GroupLayout.DEFAULT_SIZE, 191, Short.MAX_VALUE))))))
